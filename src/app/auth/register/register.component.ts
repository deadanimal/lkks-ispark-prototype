...
export class RegisterComponent implements OnInit {
  ...
  // Image
  imgLogo = 'assets/img/logo/kesedar-logo.png'
  ...
  registerFormMessages = {
    ...
    'password1': [
      ...
      { type: 'minLength', message: 'Kata laluan hendaklah sekurang-kurangnya 8 aksara' }
    ],
    'password2': [
      { type: 'required', message: 'Kata laluan diperlukan' },
      { type: 'minLength', message: 'Kata laluan hendaklah sekurang-kurangnya 8 aksara' }
  ...
  successMessage() {
    let title = 'Sila kembali log masuk'
    let message = 'Berjaya didaftar'
